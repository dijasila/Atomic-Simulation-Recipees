key_descriptions = {
    ...
    'convex_hull@main': {'ehull': 'KVP: Energy above convex hull [eV/atom]',
    ...
    'hse': {'vbm_hse_nosoc': 'HSE valence band max. w/o soc [eV]',
    ...
    'magnetic_anisotropy': {'spin_axis': 'KVP: Suggested spin direction for SOC',
    ...
    'pdos': {
        'pdos_nosoc': ('Projected density of states '
    ...
    'phonons': {'minhessianeig': 'KVP: Minimum eigenvalue of Hessian [eV/Ang^2]',
