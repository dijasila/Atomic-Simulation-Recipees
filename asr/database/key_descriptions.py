...
key_descriptions = {
    ...
    "hse": {
        ...
        "dir_gap_hse_nosoc": "Direct gap w/o soc. (HSE) [eV]",
        ...
        "dir_gap_hse": "KVP: Direct band gap (HSE) [eV]",
