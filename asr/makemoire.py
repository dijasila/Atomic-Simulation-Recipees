...
@command('asr.makemoire',
         ...
         creates=['results-asr.supercell.json', 'results-asr.supercell.xyz', 'results-asr.supercell.xsf'],
         dependencies=['asr.findmoire'])
...
@option('--stress-opt-method', type=str, choices=["approx", "exact"])
