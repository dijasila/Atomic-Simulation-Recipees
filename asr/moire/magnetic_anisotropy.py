...
def get_spin_axis():
    anis = read_json('results-asr.moire.magnetic_anisotropy.json')
...
@command('asr.moire.magnetic_anisotropy',
         tests=tests,
         returns=Result,
         dependencies=['asr.moire.magstate'])
def main() -> Result:
    ...
    magstateresults = read_json('results-asr.moire.magstate.json')
