...
def test_emasses_freelectron(asr_tmpdir_w_params, mockgpaw, mocker,
    ...
    def get_all_eigs(self):
        ...
        res_kn[:, :self.get_number_of_valence_electrons()] *= 1 / vbmass
        res_kn[:, self.get_number_of_valence_electrons():] *= 1 / cbmass
        return res_kn
...
def test_emasses_indirect(asr_tmpdir_w_params, mockgpaw, mocker,
    ...
    def get_all_eigs(self):
        ...
        n = self.get_number_of_valence_electrons()
        res_kn[:, :n] *= 1 / vbmass
        res_kn[:, n:] *= 1 / cbmass
        return res_kn
...
def _get_all_eigenvalues(self):
    ...
    eps_kn = np.concatenate((-veps_kn[:, ::-1][:, -nvalence:],
