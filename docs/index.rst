...
.. Admonition:: Overview of documentation
   ...
   The documentation is arranged like in the django python project
   `django documentation <https://docs.djangoproject.com>`_, namely
   ...
   * :ref:`API Reference`:
   ...
   works... <https://www.youtube.com/watch?v=azf6yzuJt54>`_ for 
